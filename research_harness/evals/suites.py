        ...
        tasks=[
            ...
            EvalTask(
                ...
                success_criteria=[
                    ...
                    "Optimizer phase scores against the official upstream prediction-market evaluator",
                    "solution.py is emitted for upstream evaluation",
                    "Official profit must be measured by upstream prediction-market evaluator before promotion",
                ],
                grader_ids=[
                    "outcome_completed",
                    "mode_selected",
